document.addEventListener('DOMContentLoaded', function () {
                ...
                if (Array.isArray(data) && data.length > 0) {
                    ...
                    data.forEach(function (item) {
                        ...
                        if (item.imagen) {
                            ...
                            } else if (contenedorId === 'series-details') {
    ...
    mostrarContenidoPopular('http://localhost:9000/Peliculas/Populares', 'movie-details', '../pages/Informacion.html');

    // Llama a la función para mostrar series populares
    mostrarContenidoPopular('http://localhost:9000/Series/Populares', 'series-details', '../pages/InformacionSeries.html');
});
