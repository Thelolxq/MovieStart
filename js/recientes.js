document.addEventListener('DOMContentLoaded', function () {
                ...
                if (Array.isArray(data) && data.length > 0) {
                    ...
                    data.forEach(function (item) {
                        ...
                        if (item.imagen) {
                            ...
                            if (contenedorId === 'movie-recent') {
                                enlace.href = detalleUrl + '?id=' + item.idPelicula;
                            } else if (contenedorId === 'serie-recent') {
    ...
    mostrarContenidoPopular('http://localhost:9000/Peliculas/Recientes', 'movie-recent', '../pages/Informacion.html');

    // Llama a la función para mostrar series populares
    mostrarContenidoPopular('http://localhost:9000/Series/Recientes', 'serie-recent', '../pages/InformacionSeries.html');
});
